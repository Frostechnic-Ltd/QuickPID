...
class QuickPID {
  ...
  public:
    ...
    void SetTunings(float Kp, float Ki, float Kd, float POn, float DOn, uint32_t NewSampleTimeUs);
  ...
  private:
    ...
    float dispKp = 0;       // tuning parameters for display purposes.
    float dispKi = 0;
    float dispKd = 0;
    float peTerm = 0;
    float pmTerm = 0;
    ...
    float pOn= 0;          // proportional on Error to Measurement ratio (0.0-1.0), default = 1.0
    float dOn= 0;          // derivative on Error to Measurement ratio (0.0-1.0), default = 0.0
    float kp = 0;          // (P)roportional Tuning Parameter
    float ki = 0;          // (I)ntegral Tuning Parameter
    float kd = 0;          // (D)erivative Tuning Parameter
    float kpe= 0;          // proportional on error amount
    float kpm= 0;          // proportional on measurement amount
    float kde= 0;          // derivative on error amount
    float kdm = 0;          // derivative on measurement amount
    float tf = 0;          // derivative filter time
